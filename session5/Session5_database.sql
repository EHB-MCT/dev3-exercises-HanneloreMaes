...
CREATE TABLE `S5_Customers` (
  ...
  CONSTRAINT `S5_Customers_ibfk_1` FOREIGN KEY (`salesRepEmployeeNumber`) REFERENCES `S5_Employees` (`employeeNumber`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE `S5_Employees` (
  ...
  CONSTRAINT `S5_Employees_ibfk_1` FOREIGN KEY (`reportsTo`) REFERENCES `S5_Employees` (`employeeNumber`),
  CONSTRAINT `S5_Employees_ibfk_2` FOREIGN KEY (`officeCode`) REFERENCES `S5_Offices` (`officeCode`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE `S5_Offices` (
  `officeCode` varchar(10) NOT NULL,
  `city` varchar(50) NOT NULL,
  `phone` varchar(50) NOT NULL,
  `addressLine1` varchar(50) NOT NULL,
...
CREATE TABLE `S5_orderdetails` (
  ...
  CONSTRAINT `S5_orderdetails_ibfk_1` FOREIGN KEY (`orderNumber`) REFERENCES `S5_orders` (`orderNumber`),
  CONSTRAINT `S5_orderdetails_ibfk_2` FOREIGN KEY (`productCode`) REFERENCES `S5_products` (`productCode`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE `S5_orders` (
  `orderNumber` int(11) NOT NULL,
  ...
  CONSTRAINT `S5_orders_ibfk_1` FOREIGN KEY (`customerNumber`) REFERENCES `S5_Customers` (`customerNumber`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE `S5_payments` (
  `customerNumber` int(11) NOT NULL,
  `checkNumber` varchar(50) NOT NULL,
  `paymentDate` date NOT NULL,
  `amount` decimal(10,2) NOT NULL,
  PRIMARY KEY (`customerNumber`,`checkNumber`),
  CONSTRAINT `S5_payments_ibfk_1` FOREIGN KEY (`customerNumber`) REFERENCES `S5_Customers` (`customerNumber`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE `S5_productlines` (
...
CREATE TABLE `S5_products` (
  ...
  CONSTRAINT `S5_products_ibfk_1` FOREIGN KEY (`productLine`) REFERENCES `S5_productlines` (`productLine`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `S5_Customers` (`customerNumber`, `customerName`, `contactLastName`, `contactFirstName`, `phone`, `addressLine1`, `addressLine2`, `city`, `state`, `postalCode`, `country`, `salesRepEmployeeNumber`, `creditLimit`) VALUES
...
INSERT INTO `S5_Employees` (`employeeNumber`, `lastName`, `firstName`, `extension`, `email`, `officeCode`, `reportsTo`, `jobTitle`) VALUES
...
INSERT INTO `S5_Offices` (`officeCode`, `city`, `phone`, `addressLine1`, `addressLine2`, `state`, `country`, `postalCode`, `territory`) VALUES
...
INSERT INTO `S5_orderdetails` (`orderNumber`, `productCode`, `quantityOrdered`, `priceEach`, `orderLineNumber`) VALUES
...
INSERT INTO `S5_orders` (`orderNumber`, `orderDate`, `requiredDate`, `shippedDate`, `status`, `comments`, `customerNumber`) VALUES
...
INSERT INTO `S5_payments` (`customerNumber`, `checkNumber`, `paymentDate`, `amount`) VALUES
...
INSERT INTO `S5_productlines` (`productLine`, `textDescription`, `htmlDescription`, `image`) VALUES
...
INSERT INTO `S5_products` (`productCode`, `productName`, `productLine`, `productScale`, `productVendor`, `productDescription`, `quantityInStock`, `buyPrice`, `MSRP`) VALUES
